...
public class MultiThreadPool {
    ...
    public void threadAndQueue()
        ...
        Runnable qaSendScenarios = getScenarioRunnable();
        Runnable proxyParsing = getProxyRunnable();
    ...
    private static Runnable getProxyRunnable() {
        return () -> {
            try {
    ...
    private static Runnable getScenarioRunnable() {
        return () -> {
            try {
